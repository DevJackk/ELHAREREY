...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(elharerey..":NameBot:")
...
var = 'مطور اساسي' 
elseif  UserID == 902921649 then
var =  '𝐀𝐇𝐌𝐄𝐃 𝐁𝐀𝐃𝐑❃'
elseif  UserID == 1646796547 then
var =  'المبرمج جاك'
elseif  UserID == 1487613664 then
var =  '𝐄𝐋𝐇𝐀𝐑𝐄𝐑𝐄𝐘𖣍'
elseif redis:sismember(elharerey..':SUDO_BOT:',UserID) then
var = 'مطور البوت' 
elseif redis:sismember(elharerey..':KARA_BOT:'..ChatID,UserID) then
var = ' المنشىء الاساسي' 
elseif redis:sismember(elharerey..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء' 
elseif redis:sismember(elharerey..'owners:'..ChatID,UserID) then
var = 'مدير البوت' 
elseif redis:sismember(elharerey..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت' 
elseif redis:sismember(elharerey..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز' 
else
var = 'فقط عضو' 
end
...
if msg.edited then
redis:incr(elharerey..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info then
redis:incr(elharerey..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.adduser then 
redis:incr(elharerey..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.photo then
redis:incr(elharerey..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.sticker then
redis:incr(elharerey..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.voice then
redis:incr(elharerey..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.audio then
redis:incr(elharerey..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.video or msg.video_note then
redis:incr(elharerey..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.animation then
redis:incr(elharerey..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local list = redis:smembers(elharerey..':SUDO_BOT:')
message = '❍ ** قائمه الـمـطـوريـن : \n\n`❍ مطور اساسي`**\n'..SUDO_USER..' » ❪' ..SUDO_ID.. '❫\n*———————————————— *\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n .*"
else
for k,v in pairs(list) do
local info = redis:hgetall(elharerey..'username:'..v)
local count = redis:scard(elharerey..'mtwr_count'..v)
...
local monsha = redis:smembers(elharerey..':MONSHA_BOT:'..msg.chat_id_)
if #monsha == 0 then 
...
message = message..'*————————— \n\n❍ قائمه المدراء :*\n\n'
local list = redis:smembers(elharerey..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(elharerey..'admins:'..msg.chat_id_)
...
local list = redis:smembers(elharerey..'whitelist:'..msg.chat_id_)
...
if redis:sismember(elharerey..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(elharerey..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(elharerey..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(elharerey..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(elharerey..'gban_users')
...
local list = redis:smembers(elharerey..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(elharerey..':Filter_Word:'..msg.chat_id_,word) then 
return  "❍ **الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع ." 
else
redis:sadd(elharerey..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(elharerey..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(elharerey..':Filter_Word:'..msg.chat_id_,word) 
...
EnterCmd = true
local NumberFlood = tonumber(redis:get(elharerey..':Flood_Spam:'..msg.sender_user_id_..':msgs') or 0)
if NumberFlood > 3 then 
redis:setex(elharerey..':Flood_Spam:'..msg.sender_user_id_..':Stoped',10,true)
EnterCmd = false
elseif redis:get(elharerey..':Flood_Spam:'..msg.sender_user_id_..':Stoped') then
EnterCmd = false
else
redis:setex(elharerey..':Flood_Spam:'..msg.sender_user_id_..':msgs',3,NumberFlood+1)
end
return EnterCmd
end
...
local list = redis:smembers(elharerey..'group:ids')
message = '❍ **قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(elharerey..'group:name'..v)
if info then 
...
<style>*{font-family: 'Harmattan', sans-serif;font-weight: 600;text-shadow: 1px 1px 16px elharerey;}</style>
<body>
...
redis:del(
elharerey..'group:add'..id_group,
elharerey..'lock_link'..id_group, 
elharerey..'lock_id'..id_group,
elharerey..'lock_spam'..id_group, 
elharerey..'lock_webpage'..id_group,
elharerey..'lock_markdown'..id_group,
elharerey..'lock_flood'..id_group,
elharerey..'lock_bots'..id_group,
elharerey..'mute_forward'..id_group,
elharerey..'mute_contact'..id_group,
elharerey..'mute_location'..id_group,
elharerey..'mute_document'..id_group,
elharerey..'mute_keyboard'..id_group,
elharerey..'mute_game'..id_group,
elharerey..'mute_inline'..id_group,
elharerey..'lock_username'..id_group,
elharerey..'num_msg_elharerey'..id_group,
elharerey..'replay'..id_group
)
redis:srem(elharerey..'group:ids',id_group)
end
...
redis:hset(elharerey..'username:'..data.id_,'username',ResolveUser(data))
redis:sadd(elharerey..'admins:'..msg.chat_id_,data.id_)
end,nil)
end
end
if NumAdmin == 0 then 
...
if redis:get(elharerey..'group:add'..msg.chat_id_) then  return '❍ **المجموعة تم تفعيلها مُسبقاً . ' end
...
redis:setex(elharerey..":ismember:"..msg.sender_user_id_,1500,true)
GetFullChat(msg.chat_id_,function(arg,data) 
local GroupUsers = tonumber(redis:get(elharerey..':addnumberusers') or 0)
...
local lock_service = redis:get(elharerey..'lock_service')
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(elharerey..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(elharerey..':KARA_BOT:'..msg.chat_id_,data.id_)
end)
...
redis:mset(
elharerey..'group:add'..msg.chat_id_,true,
elharerey..'lock_link'..msg.chat_id_,true, 
elharerey..'lock_id'..msg.chat_id_,true,
elharerey..'lock_spam'..msg.chat_id_,true,
elharerey..'lock_webpage'..msg.chat_id_,true,
elharerey..'lock_markdown'..msg.chat_id_,true,
elharerey..'lock_flood'..msg.chat_id_,true,
elharerey..'lock_bots'..msg.chat_id_,true,
elharerey..'mute_forward'..msg.chat_id_,true,
elharerey..'mute_contact'..msg.chat_id_,true,
elharerey..'mute_location'..msg.chat_id_,true,
elharerey..'mute_document'..msg.chat_id_,true,
elharerey..'mute_keyboard'..msg.chat_id_,true,
elharerey..'mute_game'..msg.chat_id_,true,
elharerey..'mute_inline'..msg.chat_id_,true,
elharerey..'lock_username'..msg.chat_id_,true,
elharerey..'num_msg_elharerey'..msg.chat_id_,5, 
elharerey..'replay'..msg.chat_id_,true
)

redis:sadd(elharerey..'group:ids',msg.chat_id_) 
redis:sadd(elharerey..'mtwr_count'..msg.sender_user_id_,msg.chat_id_)

GroupTitle(msg.chat_id_,function(arg,data)
local NameGroup = data.title_
redis:set(elharerey..'group:name'..msg.chat_id_,NameGroup)
...
redis:set(elharerey..'linkGroup'..msg.chat_id_,Gp_Link)
...
if not redis:get(elharerey..'group:add'..msg.chat_id_) then return '** المجموعه تم تعطيلها مُسبقاً .' end  
...
if redis:sismember(elharerey..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد منشىء  \n✓️',17,USERCAR) 
end
redis:hset(elharerey..'username:'..UserID,'username',Resolv)
redis:sadd(elharerey..':MONSHA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تمت ترقيته ليصبح منشىء \n✓️',17,USERCAR) 
end

if cmd == "remmnsha" then
if not redis:sismember(elharerey..':MONSHA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد ليس منشىء \n✓️',17,USERCAR) 
end
redis:srem(elharerey..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(elharerey..':KARA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد منشىء اساسي \n✓️',17,USERCAR) 
end
redis:hset(elharerey..'username:'..UserID,'username',Resolv)
redis:sadd(elharerey..':KARA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تمت ترقيته ليصبح منشىء اساسي \n✓️',17,USERCAR) 
end

if cmd == "remkara" then
if not redis:sismember(elharerey..':KARA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد ليس منشىء اساسي\n✓️',17,USERCAR) 
end
redis:srem(elharerey..':KARA_BOT:'..ChatID,UserID)
...
if redis:sismember(elharerey..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد عضو مميز \n✓️',17,USERCAR) 
end
redis:hset(elharerey..'username:'..UserID, 'username', Resolv)
redis:sadd(elharerey..'whitelist:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تمت ترقيته ليصبح عضو مميز \n✓️',17,USERCAR) 
end

if cmd == "remwhitelist" then
if not redis:sismember(elharerey..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد ليس عضو مميز \n✓️',17,USERCAR) 
end
redis:srem(elharerey..'whitelist:'..ChatID,UserID)
...
if redis:sismember(elharerey..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد مدير \n✓️',17,USERCAR) 
end
redis:hset(elharerey..'username:'..UserID, 'username', Resolv)
redis:sadd(elharerey..'owners:'..ChatID,UserID)
...
if redis:sismember(elharerey..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد ادمن \n✓️',17,USERCAR) 
end
redis:hset(elharerey..'username:'..UserID, 'username', Resolv)
redis:sadd(elharerey..'admins:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تمت ترقيته ليصبح ادمن \n✓️',17,USERCAR) 
end

if cmd == "remowner" then
if not redis:sismember(elharerey..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد ليس مدير \n✓️',17,USERCAR) 
end
redis:srem(elharerey..'owners:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم تنزيله من المدير  \n✓️',17,USERCAR) 
end

if cmd == "demote" then
if not redis:sismember(elharerey..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد ليس ادمن \n✓️',17,USERCAR) 
end
redis:srem(elharerey..'admins:'..ChatID,UserID)
...
if cmd == "active" then
local maseegs = redis:get(elharerey..'msgs:'..UserID..':'..ChatID) or 1
...
elseif UserID == 902921649 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك حظر 𝐀𝐇𝐌𝐄𝐃 𝐁𝐀𝐃𝐑❃\n") 
elseif UserID == 1646796547 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك حظر المبرمج جاك\n") 
elseif UserID == 1487613664 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك حظر 𝐄𝐋𝐇𝐀𝐑𝐄𝐑𝐄𝐘𖣍\n") 
elseif redis:sismember(elharerey..':SUDO_BOT:',UserID) then 
...
redis:hset(elharerey..'username:'..UserID, 'username', Resolv)
redis:sadd(elharerey..'banned:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم حظره  \n',17,USERCAR) 
end
end)
...
if cmd == "unban" then
if not redis:sismember(elharerey..'banned:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم بالتأكيد الغاء حظره  \n',17,USERCAR) 
else
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم الغاء حظره \n',17,USERCAR) 
end
redis:srem(elharerey..'banned:'..ChatID,UserID)
...
elseif UserID == 902921649 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك كتم 𝐀𝐇𝐌𝐄𝐃 𝐁𝐀𝐃𝐑❃\n") 
elseif UserID == 1646796547 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك كتم المبرمج جاك\n") 
elseif UserID == 1487613664 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك كتم 𝐄𝐋𝐇𝐀𝐑𝐄𝐑𝐄𝐘𖣍\n") 
elseif redis:sismember(elharerey..':SUDO_BOT:',UserID) then 
...
if redis:sismember(elharerey..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم بالتأكيد كتمه  \n',17,USERCAR) 
end
redis:hset(elharerey..'username:'..UserID, 'username', Resolv)
redis:sadd(elharerey..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم كتمه \n',17,USERCAR) 
end

if cmd == "unsilent" then
if not redis:sismember(elharerey..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم بالتاكيد الغاء كتمه  \n',17,USERCAR) 
end
redis:srem(elharerey..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم الغاء كتمه  \n',17,USERCAR) 
end
...
redis:hset(elharerey..'username:'..UserID, 'username',Resolv)
redis:sadd(elharerey..'gban_users',UserID)
...
redis:srem(elharerey..'gban_users',UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم الغاء حظره العام \n',17,USERCAR) 
end
...
elseif UserID == 902921649 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد 𝐀𝐇𝐌𝐄𝐃 𝐁𝐀𝐃𝐑❃\n") 
elseif UserID == 1646796547 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد المبرمج جاك\n") 
elseif UserID == 1487613664 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد 𝐄𝐋𝐇𝐀𝐑𝐄𝐑𝐄𝐘𖣍\n") 
elseif redis:sismember(elharerey..':SUDO_BOT:',UserID) then 
...
if redis:sismember(elharerey..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد مطور \n',17,USERCAR) 
end
redis:hset(elharerey..'username:'..UserID, 'username', Resolv)
redis:sadd(elharerey..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم ترقيته ليصبح مطور \n',17,USERCAR) 
end

if cmd == "dn_sudo" then
if not redis:sismember(elharerey..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد ليس مطور \n',17,USERCAR) 
end
redis:srem(elharerey..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم تنزيله من المطور \n',17,USERCAR) 
end  -- End Cmd 
end,nil)
else
...
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك تقييد المطور الاساسي\n") 
elseif UserID == 902921649 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك تقييد 𝐀𝐇𝐌𝐄𝐃 𝐁𝐀𝐃𝐑❃\n") 
elseif UserID == 1646796547 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك تقييد المبرمج جاك\n") 
elseif UserID == 1487613664 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك تقييد 𝐄𝐋𝐇𝐀𝐑𝐄𝐑𝐄𝐘𖣍\n") 
elseif redis:sismember(elharerey..':SUDO_BOT:',UserID) then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك تقييد المطور\n") 
elseif redis:sismember(elharerey..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك تقييد المنشئ\n") 
...
redis:hset(elharerey..'username:'..UserID, 'username', UserName)
redis:sadd(elharerey..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(elharerey..'banned:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'❍ **العضو » ❪ '..UserName..' ❫\n❍ **الايدي » ❪ `'..UserID..'` ❫\n❍ **تم بالتأكيد حظره \n') 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد المطور الاساسي\n")
elseif UserID == 902921649 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد 𝐀𝐇𝐌𝐄𝐃 𝐁𝐀𝐃𝐑❃n") 
elseif UserID == 1646796547 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد المبرمج جاك\n") 
elseif UserID == 1487613664 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد 𝐄𝐋𝐇𝐀𝐑𝐄𝐑𝐄𝐘𖣍\n") 
...
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد المطور\n") 
elseif
redis:sismember(elharerey..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد المنشئ\n") 
elseif redis:sismember(elharerey..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد المدير\n") 
elseif redis:sismember(elharerey..'admins:'..ChatID,UserID) then 
...
Restrict(ChatID,UserID,1)
redis:hset(elharerey..'username:'..UserID, 'username', Resolv)
redis:sadd(elharerey..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم تقييد آلعضـو بنجاح \n',17,USERCAR) 
end 
if cmd =="fktqeed" then
  Restrict(ChatID,UserID,2)
  redis:srem(elharerey..':tqeed:'..ChatID,UserID)
...
if cmd == "dn_sudo" then
if not redis:sismember(elharerey..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'❍ **العضو » '..USERNAME..' \n❍ ** الايدي » (`'..UserID..'`)\n❍ **انه بالتأكيد ليس مطور \n') end
redis:srem(elharerey..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم تنزيله من المطور \n',17,USERCAR) 
end
...
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد المطور الاساسي\n")
elseif UserID == 902921649 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك 𝐀𝐇𝐌𝐄𝐃 𝐁𝐀𝐃𝐑❃\n")  
elseif UserID == 1646796547 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد المبرمج جاك\n") 
elseif UserID == 1487613664 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد 𝐄𝐋𝐇𝐀𝐑𝐄𝐑𝐄𝐘𖣍\n") 
...
if redis:get(elharerey..'welcome:get'..msg.chat_id_) then welcomex = "❪ مفعل ❫" else welcomex = "❪ معطل ❫" end
if redis:get(elharerey..'lock_id'..msg.chat_id_) then lock_idx = "❪ مفعل ❫" else lock_idx = "❪ معطل ❫" end
if redis:get(elharerey..'replay'..msg.chat_id_)  then replayx  = "❪ مفعل ❫" else replayx  = "❪ معطل ❫" end
if redis:get(elharerey..'lock_woring'..msg.chat_id_) then lock_woringx = "❪ مفعل ❫" else lock_woringx  = "❪ معطل ❫" end
list_settings = "*❍*` اعدادات المجموعه :` \n"
.."\n❍ التعديل «» "..(redis:get(elharerey..'lock_edit'..msg.chat_id_) or 'false')
.."\n❍ الروابط «» "..(redis:get(elharerey..'lock_link'..msg.chat_id_) or 'false')
.."\n❍ التاك «» "..(redis:get(elharerey..'lock_tag'..msg.chat_id_) or 'false')
.."\n❍ المعرفات «» "..(redis:get(elharerey..'lock_username'..msg.chat_id_) or 'false')
.."\n❍ التكرار «» "..(redis:get(elharerey..'lock_flood'..msg.chat_id_) or 'false')
.."\n❍ الكلايش «» "..(redis:get(elharerey..'lock_spam'..msg.chat_id_) or 'false')
.."\n❍ الويب «» "..(redis:get(elharerey..'lock_webpage'..msg.chat_id_) or 'false')
.."\n❍ الماركدوان «» "..(redis:get(elharerey..'lock_markdown'..msg.chat_id_) or 'false')
.."\n❍ بالطرد البوتات «» "..(redis:get(elharerey..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n❍ البوتات «» "..(redis:get(elharerey..'lock_bots'..msg.chat_id_) or 'false')
.."\n❍ عدد التكرار «» "..(redis:get(elharerey..'num_msg_elharerey'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n❍`اعدادات الوسائط :`\n"
.."\n*❍ *المتحركه «» "..(redis:get(elharerey..'mute_gif'..msg.chat_id_) or 'false')
.."\n❍ الدردشه «» "..(redis:get(elharerey..'mute_text'..msg.chat_id_) or 'false')
.."\n❍ الانلاين «» "..(redis:get(elharerey..'mute_inline'..msg.chat_id_) or 'false')
.."\n❍ الالعاب «» "..(redis:get(elharerey..'mute_game'..msg.chat_id_) or 'false')
.."\n❍ الصور «» "..(redis:get(elharerey..'mute_photo'..msg.chat_id_) or 'false')
.."\n❍ الفيديو «» "..(redis:get(elharerey..'mute_video'..msg.chat_id_) or 'false')
.."\n❍ البصمات «» "..(redis:get(elharerey..'mute_audio'..msg.chat_id_) or 'false')
.."\n❍ الصوت «» "..(redis:get(elharerey..'mute_voice'..msg.chat_id_) or 'false')
.."\n❍ الملصقات «» "..(redis:get(elharerey..'mute_sticker'..msg.chat_id_) or 'false')
.."\n❍ الجهات «» "..(redis:get(elharerey..'mute_contact'..msg.chat_id_) or 'false')
.."\n❍ التوجيه «» "..(redis:get(elharerey..'mute_forward'..msg.chat_id_) or 'false')
.."\n❍ الموقع «» "..(redis:get(elharerey..'mute_location'..msg.chat_id_) or 'false')
.."\n❍ الملفات «» "..(redis:get(elharerey..'mute_document'..msg.chat_id_) or 'false')
.."\n❍ الاشعارات «» "..(redis:get(elharerey..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n❍ الكيبورد «» "..(redis:get(elharerey..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*❍*`اعدادات اخرى : `"
.."\n\n*❍*الترحيب «» "..welcomex
.."\n*❍*الردود «» "..replayx
...
.."\n*❍*الويب «» "..(redis:get(elharerey..'lock_webpage'..msg.chat_id_) or 'false')
.."\n*❍*الماركدوان «» "..(redis:get(elharerey..'lock_markdown'..msg.chat_id_) or 'false')
.."\n*❍*البوتات بالطرد «» "..(redis:get(elharerey..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n*❍*البوتات «» "..(redis:get(elharerey..'lock_bots'..msg.chat_id_) or 'false')
.."\n*❍*عدد التكرار «» "..(redis:get(elharerey..'num_msg_elharerey'..msg.chat_id_) or 'false')
.."\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*❍*اعدادات التقـييد :\n"
.."\n*❍*التقييد بالتوجيه «» "..(redis:get(elharerey..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*❍*التقييد بالصور «» "..(redis:get(elharerey..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*❍*التقييد بالروابط «» "..(redis:get(elharerey..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*❍*التقييد بالمتحركه «» "..(redis:get(elharerey..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*❍*التقييد الفيديو «» "..(redis:get(elharerey..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
